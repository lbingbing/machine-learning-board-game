...
class MctsTree:
    def __init__(self, model, root_state, player_id, sim_num, self_play, dirichlet_factor = None, dirichlet_alpha = None):
        self.model = model
    ...
    def get_legal_Ps(self):
        ...
        for sim_id in range(self.sim_num):
            ...
            if result>=0:
                ...
                if self.self_play and not node.parent:
