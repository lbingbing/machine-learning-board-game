...
public:
    ...
    BlackWhiteState(int board_height, int board_width) : m_board_height(board_height), m_board_width(board_width), m_board(board_height, std::vector<int>(board_width)) { reset(); }
